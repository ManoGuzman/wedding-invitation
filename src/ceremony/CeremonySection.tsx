import { SECTIONS, COLORS } from "@/invitation/invitation.constants";
...
const CeremonySection = () => (
    <g>
        ...
        <path
            ...
            style={{ fill: COLORS.SECONDARY, fillOpacity: 1, strokeWidth: 0.600485 }}
        />
        <a
            id="ceremony-map-link"
            href={SECTIONS.CEREMONY.MAP_URL}
            target="_blank"
